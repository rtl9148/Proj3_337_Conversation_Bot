...
class ActionLookupQuestionAct(Action):

    def name(self) -> Text:
        return "action_lookup_question_act"
    ...
    def run(self, dispatcher: CollectingDispatcher,
       ...
       #lookup question based on current step we are on
        ...
        return_message = agent.search_reference_answer(category = 'act')
        dispatcher.utter_message(text=return_message)
        return []
    
class ActionLookupQuestionObj(Action):

    def name(self) -> Text:
        return "action_lookup_question_obj"
    ...
    def run(self, dispatcher: CollectingDispatcher,
       ...
       #lookup question based on current step we are on
        ...
        return_message = agent.search_reference_answer(category = 'obj')
        dispatcher.utter_message(text=return_message)
        return []
...
class ActionLookupQuantity(Action):

    def name(self) -> Text:
        return "action_lookup_quant"
    ...
    def run(self, dispatcher: CollectingDispatcher,
       ...
       #no slots needed here, just print this out
        ...
        return_message = agent.search_parameter(q_obj = amount_item, category = 'quantity')
        dispatcher.utter_message(text = return_message)
        return [SlotSet('amount_item', None)]

class ActionLookupDuration(Action):

    def name(self) -> Text:
        return "action_lookup_time"
    ...
    def run(self, dispatcher: CollectingDispatcher,
       ...
       #no slots needed here, just print this out
        ...
        #just printing out item right now, we need to find the amount
        return_message = agent.search_parameter(category = 'duration')
        dispatcher.utter_message(text=return_message)
        return []
        
class ActionLookupTemperature(Action):

    def name(self) -> Text:
        return "action_lookup_temp"
    ...
    def run(self, dispatcher: CollectingDispatcher,
       ...
       #no slots needed here, just print this out
        ...
        #just printing out item right now, we need to find the amount
        return_message = agent.search_parameter(category = 'temperature')
        dispatcher.utter_message(text=return_message)
        return []
...
class ActionLookupIngredientSubstitution(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
       ...
       #no slots needed here, just print this out
        ...
        return_message = agent.search_substituation(ingred_subst)
        dispatcher.utter_message(text=return_message)
        return [SlotSet('ingred_subst', None)]
